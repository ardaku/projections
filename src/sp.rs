...
//! implement [`Future`](core::future::Future) or other traits usually requiring
//! pinned references into a structurally-pinned type on a newtype.
//!
//! ```rust
